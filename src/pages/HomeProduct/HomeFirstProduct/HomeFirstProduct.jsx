...
import styles from "./HomeFirstProduct1.module.css"
export const HomeFirstProduct1 = () => {
    ...
    const getData = async () => {
        axios.get(`http://localhost:8080/Special_Offers?_page=${page}&_limit=3`).then(({ data }) => {
            setWatchData(data)
